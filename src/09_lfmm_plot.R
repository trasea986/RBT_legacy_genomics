...
df <- read.csv('../outputs/allraw_lfmm1_K9.csv')
df <- read.csv('../outputs/allraw_lfmm2_K9.csv')
df <- read.csv('../outputs/allraw_lfmm3_K9.csv')
df <- read.csv('../outputs/allraw_lfmm4_K9.csv')
df <- read.csv('../outputs/allraw_lfmm5_K9.csv')
df <- read.csv('../outputs/allraw_lfmm6_K9.csv')
df <- read.csv('../outputs/allraw_lfmm7_K9.csv')
df <- read.csv('../outputs/allraw_lfmm8_K9.csv')
df <- read.csv('../outputs/allraw_lfmm9_K9.csv')
...
write.csv(df, "../outputs/final_lfmm_K9.csv") ###EDIT ME###
