...
df_cand <- read.csv("../../outputs/no_koot/RDA_cand_cor.csv")
df_all <- read.csv("../../outputs/no_koot/RDA_all_SNP_cor.csv")
...
write.csv(df_ggplot, "../../outputs/no_koot/figures/final_rda_plot.csv", row.names=FALSE)
...
ggsave(filename = "../../outputs/no_koot/figures/RDA_man.png", plot = man_plot, height = 6, width = 10, units = "in")
...
ggsave(filename = "../../outputs/no_koot/figures/RDA_man_cands.png", plot = man_plot, height = 6, width = 10, units = "in")
...
rbt_rda <- readRDS('../../outputs/no_koot/rbt_rda.RDS')
...
#saveRDS(res_rdadapt, '../../outputs/no_koot/res_rdadapt.RDS')
res_rdadapt <- readRDS('../../outputs/no_koot/res_rdadapt.RDS')

#need to add back in the names and then do separation as above

#Load allele frequency matrix
allele_freq <- fread('../../outputs/no_koot/allele_freq.csv')
...
df_ggplot <- df_ggplot %>% filter (chr_name != "NW")
print('Finished prepping ggplot file and formatting snp names')
write.csv(df_ggplot, "../../outputs/no_koot/figures/final_rda_plot_pvals.csv", row.names=FALSE)
...
ggsave(filename = "../../outputs/no_koot/figures/RDA_plot_p.png", plot = man_plot, height = 6, width = 10, units = "in")
...
ggsave(filename = "../../outputs/no_koot/figures/RDA_plot_q.png", plot = man_plot, height = 6, width = 10, units = "in")