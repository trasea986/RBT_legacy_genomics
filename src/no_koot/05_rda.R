...
#run from src/no_koot directory (where the slurm batch scripts are)
...
env_mat <- read.csv('../../outputs/no_koot/env_rda.csv')
...
#if wanting to check again the corr
...
#write rda object
saveRDS(rbt_rda, '../../outputs/no_koot/rbt_rda.RDS')

rbt_rsquare <- vegan::RsquareAdj(rbt_rda) #R squared values

write.csv(rbt_rsquare, '../../outputs/no_koot/rbt_rsquare.csv')
...
write.csv(rbt_prop_variance, '../../outputs/no_koot/rbt_prop_variance.csv')
...
signif_full
saveRDS(signif_full, file = "../../outputs/no_koot/signif_full.RDS")
...
saveRDS(signif_axis, file = "../../outputs/no_koot/signif_axis.RDS")
write.csv(signif_axis, file = "../../outputs/no_koot/signif_axis.csv")
...
saveRDS(signif_term, file = "../../outputs/no_koot/signif_term.RDS")
write.csv(signif_term, file = "../../outputs/no_koot/signif_term.csv")
...
saveRDS(load_rda, file = "../../outputs/no_koot/load_rda.RDS")
...
write.csv(cand, "../../outputs/no_koot/RDA_cand_cor.csv", row.names = FALSE)
...
#Write the output into a .csv
write.csv(cand, "../../outputs/no_koot/RDA_all_SNP_cor.csv", row.names = FALSE)
