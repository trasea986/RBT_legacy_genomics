...
saveRDS(model1, file = "../../outputs/no_koot/load_LFMM1.RDS")
saveRDS(model2, file = "../../outputs/no_koot/load_LFMM2.RDS")
saveRDS(model3, file = "../../outputs/no_koot/load_LFMM3.RDS")
saveRDS(model4, file = "../../outputs/no_koot/load_LFMM4.RDS")
saveRDS(model5, file = "../../outputs/no_koot/load_LFMM5.RDS")
saveRDS(model6, file = "../../outputs/no_koot/load_LFMM6.RDS")
saveRDS(model7, file = "../../outputs/no_koot/load_LFMM7.RDS")
saveRDS(model8, file = "../../outputs/no_koot/load_LFMM8.RDS")
saveRDS(model9, file = "../../outputs/no_koot/load_LFMM9.RDS")
...
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm1_K9.csv", row.names=FALSE)
 
df <- lfmm2.test(object = model2, input = rbeta_data, env = env_lfmm2, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm2)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm2_K9.csv", row.names=FALSE) 

df <- lfmm2.test(object = model3, input = rbeta_data, env = env_lfmm3, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm3)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm3_K9.csv", row.names=FALSE) 

df <- lfmm2.test(object = model4, input = rbeta_data, env = env_lfmm4, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm4)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm4_K9.csv", row.names=FALSE) 

df <- lfmm2.test(object = model5, input = rbeta_data, env = env_lfmm5, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm5)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm5_K9.csv", row.names=FALSE) 

df <- lfmm2.test(object = model6, input = rbeta_data, env = env_lfmm6, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm6)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm6_K9.csv", row.names=FALSE) 

df <- lfmm2.test(object = model7, input = rbeta_data, env = env_lfmm7, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm7)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm7_K9.csv", row.names=FALSE) 

df <- lfmm2.test(object = model8, input = rbeta_data, env = env_lfmm8, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm8)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm8_K9.csv", row.names=FALSE) 

df <- lfmm2.test(object = model9, input = rbeta_data, env = env_lfmm9, linear = TRUE)
df_pval <- df$pval
env <- names(env_lfmm9)
df_pval <- cbind(df_pval, env)
write.csv(df_pval, file = "../../outputs/no_koot/allraw_lfmm9_K9.csv", row.names=FALSE) 
