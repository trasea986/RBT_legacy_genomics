...
fwrite(output_M1, "../outputs/M1_sim.csv", row.names = FALSE)
...
fwrite(output_M2, "../outputs/M2_sim.csv", row.names = FALSE)
...
output_M1 <- fread("../outputs/M1_sim.csv")
output_M2 <- fread("../outputs/M2_sim.csv")
output_TR <- fread("../outputs/TR_sim.csv")
output_C <- fread("../outputs/C_sim.csv")
listofdf <- c('output_LJ', 'output_BJ', 'output_D', 'output_W', 'output_K', 'output_LW', 'output_DR', 'output_FA', 'output_M1', 'output_M2', 'output_TR', 'output_C')
